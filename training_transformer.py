...
class TrainTransformer:
    ...
    def train(self, args):
        ...
        for epoch in range(args.epochs):
            ...
            vutils.save_image(log["rec"], os.path.join("rec", f"rec_{rec_epoch}.jpg"))
            plot_images(log)
            if epoch % 10 == 0:
                torch.save(self.model.state_dict(), os.path.join("checkpoints", f"transformer_last.pt"))
...
if __name__ == '__main__':
    ...
    args.checkpoint_path = r"/root/VQGAN-pytorch-main/checkpoints/last.pt"
