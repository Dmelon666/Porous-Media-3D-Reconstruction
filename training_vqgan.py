...
from vqgan import VQGAN, Discriminator, LPIPS
        ...
        for epoch in range(args.epochs):
            ...
            with tqdm(range(len(train_dataset))) as pbar:
                for i, imgs in zip(pbar, train_dataset):
                    ...
                    pbar.update(0)
            if epoch % 20 == 0:
                torch.save(self.vqgan.state_dict(), os.path.join("checkpoints", f"last.pt"))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=2001, help='Number of epochs to train (default: 50)')
